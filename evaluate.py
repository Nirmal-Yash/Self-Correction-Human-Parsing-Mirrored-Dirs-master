...
def main():
    ...
    # Check for nested keys and remove 'module.' prefix
    if 'state_dict' in state_dict:
        state_dict = state_dict['state_dict']
    
    new_state_dict = {}
    for k, v in state_dict.items():
        # Correctly format the key name for InPlaceABNSync
        name = k.replace("bn.", "bn.") # No change here
        name = name.replace("context_encoding.stages.0.2.", "context_encoding.stages.0.2.bn.")
        ...
        name = name.replace("module.", "") # Still need to handle the module. prefix
